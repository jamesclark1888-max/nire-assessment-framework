...
- D3, D4, D7 medium-band recommendation templates added: 9 new templates covering q3.7 (improvable-icp-depth), q4.6 (improvable-retention-metric), q4.7 (improvable-customer-story), q4.8 (improvable-product-roadmap), q4.10 (improvable-product-iteration), q7.4 (partial-incumbent-response), q7.6 (thin-moat-compounding), q7.7 (thin-switching-costs), q7.9 (partial-competitive-deal). Corresponding medium-score triggers updated in all three questions.yaml files.
